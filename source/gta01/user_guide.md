...
GTA1000 Series 麦克风板（线形）正面布局图（以 154 mm × 15 mm 规格为例）
```
...
GTA1000 Series 麦克风板（线形）背面布局图（以 154 mm × 15 mm 规格为例）
```

```{important} 尺寸与布局说明
以上图示仅以 `154 mm × 15 mm`（BOD0043）规格的线形板作为布局参考示例。
